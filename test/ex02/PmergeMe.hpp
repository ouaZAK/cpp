...
typedef std::deque< std::pair< std::deque<std::deque<int> >, std::deque< std::deque<int> >::iterator > > pend;
typedef std::pair< std::deque< std::deque<int> >, std::deque< std::deque<int> >::iterator > pendPair;
